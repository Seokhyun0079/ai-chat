...
このプロジェクトは、パーソナライズされた AI チャットボットを作成しようとする試みから始まりました。FastAPI バックエンドと Next.js フロントエンドで構成された現代的な Web アプリケーションです。
...
_デモ動画: AI Chat アプリケーションの基本的な機能と使用方法_
...
- **リアルタイムチャット**: WebSocket ベースのリアルタイム対話
...
이 프로젝트는 개인화된 AI 챗봇을 만들고자 하는 시도에서 시작되었습니다. FastAPI 백엔드와 Next.js 프론트엔드로 구성된 현대적인 웹 애플리케이션입니다.
